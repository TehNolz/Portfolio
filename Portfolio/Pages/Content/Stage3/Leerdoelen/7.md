...
Voor mijn Portfolio heb ik een *DocumentService* gemaakt. Deze service geeft mij de mogelijkheid om in mijn gehele applicatie Markdown bestanden te laden en om te zetten naar HTML, zodat ik ze op een pagina kan laten zien.

Voor mijn stageopdracht heb ik een *UserService* gemaakt. Via deze service kunnen alle onderdelen van het vernieuwde CRM systeem van Ranshuijsen de gegevens van de huidige gebruiker ophalen. Ook heeft deze service een functie om te controleren of een gebruiker bepaalde toegangsrechten heeft..
